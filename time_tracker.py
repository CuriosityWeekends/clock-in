...
class TimeTrackerApp:
    def __init__(self, root):
        ...
        # UI elements
        self.timer_label = ttk.Label(root, text="00:00:00", font=("Arial", 32))  # Use Arial for cross-platform compatibility
        ...
        # Save CSV file in the user's home directory
        self.csv_file = os.path.join(os.path.expanduser("~"), "session_log.csv")
        self.load_log()
